            ...
            <Popover>
              ...
              <PopoverContent className="w-80 p-0">
                <div className="p-4 border-b">
                  <h3 className="font-medium text-lg">Atualizações Recentes</h3>
                </div>
                  ...
                  {notifications.length > 0 ? (
                    notifications.map((notif) => (
                      <div 
                        key={notif.id} 
                        className={cn(
                          "p-4 border-b flex flex-col gap-1 transition-colors hover:bg-gray-50",
                          !notif.isRead && "bg-blue-50"
                        )}
                      >
                        <p className="text-sm font-medium">{notif.message}</p>
                        <time className="text-xs text-gray-500">{notif.timestamp}</time>
                      </div>
                    ))
                  ) : (
