  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-sidebar to-sidebar/70 p-4">
      <div className="bg-white/95 rounded-lg shadow-lg p-8 max-w-md w-full text-center">
        <h1 className="text-3xl font-bold text-custom-red mb-4">Acesso Negado</h1>
        <p className="text-black mb-6">
          Desculpe, sua conta ({user?.email}) com acesso {user?.accessLevel === "administrative" ? "administrativo" : user?.accessLevel === "viewer" ? "visualizador" : "operacional"} não tem
